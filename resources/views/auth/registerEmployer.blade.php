        ...
        <div class="bg-gradient-to-br from-black/30 via-black/10 to-black/90 rounded-2xl border border-zinc-400 shadow-2xl p-6 max-w-6xl w-full relative z-10">
            ...
            <form action="/login" method="get" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="location" class="block text-white/70 text-md font-medium mb-1">Location</label>
                        <input type="text" id="location" name="location" placeholder="Location" class="w-full px-4 py-3 rounded-lg bg-white/10 text-white border border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition" required>
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="email" class="block text-white/70 text-md font-medium mb-1">Company Email</label>
                    ...
                    <div>
                        <label for="email" class="block text-white/70 text-md font-medium mb-1">Contact Number</label>
